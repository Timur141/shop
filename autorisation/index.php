...
<main class="page-authorization">
    ...
    <form class="custom-form" action="" method="post">
        ...
        <?php if (isAutorised() && !loggedIn()):

            //$userLogin = $_COOKIE['login'];
            require($_SERVER['DOCUMENT_ROOT'] . '/templates/loginLogic.php');

        elseif (loggedIn()):

            require($_SERVER['DOCUMENT_ROOT'] . '/success/success.php');
            require($_SERVER['DOCUMENT_ROOT'] . '/templates/logoutForm.php');
